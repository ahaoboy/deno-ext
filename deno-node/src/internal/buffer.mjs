...
import { core } from "@deno-ext/core";
import { op_is_ascii, op_is_utf8 } from "@deno-ext/core/ops";

import { TextDecoder, TextEncoder } from "ext:deno_web/08_text_encoding.js";
import { codes } from "@deno-ext/node/internal/error_codes";
import { encodings } from "@deno-ext/node/internal_binding/string_decoder.ts";
import {
  indexOfBuffer,
  indexOfNumber,
} from "@deno-ext/node/internal_binding/buffer.ts";
import {
  asciiToBytes,
  base64ToBytes,
  base64UrlToBytes,
  ...
  hexToBytes,
  utf16leToBytes,
} from "@deno-ext/node/internal_binding/_utils.ts";
import {
  isAnyArrayBuffer,
  isArrayBufferView,
  isTypedArray,
} from "@deno-ext/node/internal/util/types";
import { normalizeEncoding } from "@deno-ext/node/internal/util.mjs";
import { validateBuffer } from "@deno-ext/node/internal/validators.mjs";
import { isUint8Array } from "@deno-ext/node/internal/util/types";
import { ERR_INVALID_STATE, NodeError } from "@deno-ext/node/internal/errors";
import {
