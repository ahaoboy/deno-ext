...
import {
  kHandle,
  kKeyObject,
} from "@deno-ext/node/internal/crypto/constants";
import { isStringOrBuffer } from "@deno-ext/node/internal/crypto/cipher.ts";
import {
...
import { hideStackFrames } from "@deno-ext/node/internal/errors";
import {
  isCryptoKey as isCryptoKey_,
  isKeyObject as isKeyObject_,
  kKeyType,
} from "@deno-ext/node/internal/crypto/_keys";
import {
  validateObject,
  validateOneOf,
