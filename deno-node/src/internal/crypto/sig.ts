...
import { op_node_sign, op_node_verify } from "@deno-ext/core/ops";
...
import type { WritableOptions } from "@deno-ext/node/_stream.d.ts";
import Writable from "@deno-ext/node/internal/streams/writable.mjs";
import type {
  BinaryLike,
  ...
  PrivateKeyInput,
  PublicKeyInput,
} from "@deno-ext/node/internal/crypto/types.ts";
import {
  KeyObject,
  prepareAsymmetricKey,
} from "@deno-ext/node/internal/crypto/keys.ts";
import { createHash, Hash } from "@deno-ext/node/internal/crypto/hash.ts";
import { KeyFormat, KeyType } from "@deno-ext/node/internal/crypto/types.ts";
import { isArrayBufferView } from "@deno-ext/node/internal/util/types";
import { ERR_CRYPTO_SIGN_KEY_REQUIRED } from "@deno-ext/node/internal/errors";
