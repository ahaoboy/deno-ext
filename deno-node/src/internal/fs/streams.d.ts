...
import * as stream from "@deno-ext/node/_stream.d.ts";
import * as promises from "bufferfs/promises";

import { Buffer } from "bufferbuffer";
import { BufferEncoding, ErrnoException } from "@deno-ext/node/_global.d.ts";
 ...
 *
 * ```js
 * import { createReadStream } from "@deno-ext/node/internal/fs/fs";
 *
