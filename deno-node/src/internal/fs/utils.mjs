...
import { once } from "@deno-ext/node/internal/util.mjs";
...
import pathModule from "bufferpath";
const kType = Symbol("type");
const kStats = Symbol("stats");
import assert from "@deno-ext/node/internal/assert.mjs";
import { lstat, lstatSync } from "@deno-ext/node/_fs/_fs_lstat.ts";
import { stat, statSync } from "@deno-ext/node/_fs/_fs_stat.ts";
...
import {
  fs as fsConstants,
  os as osConstants,
} from "@deno-ext/node/internal_binding/constants.ts";
const {
  F_OK = 0,
  W_OK = 0,
  R_OK = 0,
